...
sudo ./runcthon --server $HOST --serverdir /ibm/gpfs0/hudson64/root/$NODE_NAME --onlyv3 --noudp
sudo ./runcthon --unmountall
...
sudo ./runcthon --unmountall
ssh -tt root@$HOST service nfs-ganesha-gpfs restart || exit 1
./runcthon --server $HOST --serverdir /ibm/gpfs0/hudson64/jenkins/$NODE_NAME --onlyv3 --noudp
sudo ./runcthon --unmountall
